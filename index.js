...
const appSettings = {
    databaseURL: "https://playground-a5039-default-rtdb.europe-west1.firebasedatabase.app/"
    }
...
addButtonEl.addEventListener("click", function() {
    ...
    if (inputValue !== "") {
        ...
        checkValueExists(inputValue).then((exists) => {
            ...
            if (exists) {
             ...
             }).catch((error) => { // in the case of an error in the promise chain
